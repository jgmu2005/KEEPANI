...
try {
    ...
    if ($id === null) {
        ...
        if (!$loc) {
            out(404, ['ok' => false, 'error' => 'No pudimos leer ese enlace. Pegá el link de un PRODUCTO (no de una búsqueda o categoría). Tiendas soportadas: Siman, Sinsa, Walmart, La Curacao, RadioShack, Tropigas, El Gallo y Copasa.']);
        }
